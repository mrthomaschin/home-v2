...
import SocialMedia from "../Components/sm_bar";
              ...
              <div class="row">
                ...
                <div class="col-5 text-body ">
                  ...
                  <img
                    ...
                    src={require("../Assets/Images/photography/lol.jpg")}
                    alt="pic"
                  />
                </div>
              </div>
                ...
                <div className="each-slide">
                  <div>
                    <img
                      ...
                      src={require("../Assets/Images/photography/grad" +
                        slideImages1[0])}
                      alt="pic"
                    />
                  </div>
              ...
              <Slide {...properties}>
                <div className="each-slide">
                  <div>
                    <img
                      class="photos-img shadow"
                      src={require("../Assets/Images/photography/fam" +
                        slideImages2[0])}
                      alt="pic"
                    />
                  </div>
